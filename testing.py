...
for dataset in datasets:
    ...
    for app in range(1, 2):
        for iteration in range(5):
            ...
            with open("Dataset/letter35_fold/" + dataset + "/test" + str(iteration), encoding="utf8") as file:
                lines = file.readlines()
            words = [line.rstrip() for line in lines]

            with open("result/" + dataset + "/" + str(cc) + "cub/train_res_app" + str(app) + "_it" + str(iteration),
            ...
            with open("result/" + dataset + "/" + str(cc) + "cub/test_res_app" + str(app) + "_it" + str(iteration),
