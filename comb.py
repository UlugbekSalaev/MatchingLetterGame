...
cubes['fr']['lf'] = [ ['a', 'ê', 'e', 't', 'g', 'ë'], ['e', 'è', 'i', 'd', 'k', 'ç'], ['i', 'ô', 'o', 's', 'f', 'à'], ['o', 'â', 'u', 'b', 'j', 'n'], ['u', 'œ', 'n', 'c', 'w', 'r'], ['é', 'û', 'r', 'p', 'x', 'l'], ['y', 'î', 'l', 'v', 'z', 't'], ['ï', 'a', 'm', 'h', 'q', 's'] ]
...
cubes['fr']['vl'] = [ ['a', 'ê', 'e', 'â', 'b', 'j'], ['e', 'è', 'i', 'n', 'c', 'w'], ['i', 'ô', 'o', 'r', 'p', 'x'], ['o', 'â', 'u', 'l', 'v', 'z'], ['u', 'œ', 'é', 'm', 'h', 'q'], ['é', 'û', 'y', 't', 'g', 'ë'], ['y', 'î', 'ê', 'd', 'k', 'ç'], ['ï', 'a', 'è', 's', 'f', 'à']  ]
...
for dataset in ['de','es','fr','kz','ms','pl','tr','tt']:
    print(dataset)
    case = 0
